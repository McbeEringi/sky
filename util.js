...
:root,.input,.btn{
	--bc:#222;--fc:#fff;--l:#fea;--s:#aef;--acc:#f80;--b0:#7af;--b1:#acf;--b2:#def;--p0:#a7f;--p1:#caf;--p2:#edf;--r0:#f00;--r1:#f44;
	--g:#2228;--w:#fff8;--btn:64px;--bp:0 0;--items:200px;
	background-color:var(--bc);color:var(--fc);accent-color:var(--acc);font-family:'Zen Maru Gothic',sans-serif;text-shadow:0 0 .5ex var(--bc);
}
