...
if(urlq.pwa&&(localStorage.sky_1time||0)<1)document.body.insertAdjacentHTML('beforeend',`<div style="display:inline-block;position:fixed;padding:8px;top:0;left:0;background-color:#222;z-index:20;">アンケートのお願い<br>5問程度の簡単なものです。次の改修の参考のためお願いします。<br><br><a href="https://forms.gle/EgqHvrqu8MsC2Vku7" onclick="localStorage.sky_1time=1;">アンケート Google Form</a> <button onclick="localStorage.sky_1time=1;this.parentNode.remove();">この表示を消す</button></div>`);
